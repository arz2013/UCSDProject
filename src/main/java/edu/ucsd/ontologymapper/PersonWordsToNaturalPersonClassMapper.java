...
public class PersonWordsToNaturalPersonClassMapper implements WordsToOntologyClassMapper {
	@Inject
	...
	@Override
	public void map() {
		Node organizationOntologyNode = ontologyDao.getOntologyEntityWithFragment(OwlFragment.NATURAL_PERSON.getFragmentName());
		List<Word> orgWords = sentenceDao.getWordsWithNeTag(NeTags.PERSON.name());
